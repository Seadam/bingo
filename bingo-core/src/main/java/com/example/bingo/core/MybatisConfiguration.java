...
public class MybatisConfiguration extends Configuration {
    ...
    public MybatisConfiguration() {
        ...
        languageRegistry.setDefaultDriverClass(com.example.bingo.core.MybatisXMLLanguageDriver.class);
    }
    ...
    public void setDefaultScriptingLanguage(Class<? extends LanguageDriver> driver) {
        if (driver == null) {
            ...
            driver = com.example.bingo.core.MybatisXMLLanguageDriver.class;
        }

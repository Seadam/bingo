...
import com.example.bingo.core.metadata.TableInfoHelper;
...
public class InsertOrUpdate extends AbstractMethod {
    ...
    public MappedStatement injectMappedStatement(Class<?> mapperClass, Class<?> modelClass, TableInfo tableInfo) {
        ...
        SqlMethod sqlMethod = SqlMethod.INSERT_OR_UPDATE;
        String columnScript = SqlScriptUtils.convertTrim(tableInfo.getAllInsertSqlColumnIncPkMaybeIf(null),
            LEFT_BRACKET, RIGHT_BRACKET, null, COMMA);
        String valuesScript = SqlScriptUtils.convertTrim(tableInfo.getAllInsertSqlPropertyIncPkMaybeIf(null),
            LEFT_BRACKET, RIGHT_BRACKET, null, COMMA);
        ...
        String sql = String.format(sqlMethod.getSql(), tableInfo.getTableName(), columnScript, valuesScript,
                sqlSetIncludePk(tableInfo.isWithLogicDelete(), false, tableInfo, false, null, null));

 ...
 */
package com.example.bingo.core;
...
import com.example.bingo.core.injector.SqlRunnerInjector;
import com.example.bingo.core.toolkit.GlobalConfigUtils;
import com.example.bingo.core.toolkit.IdWorker;
...
public class MybatisSqlSessionFactoryBuilder extends SqlSessionFactoryBuilder {
    ...
    public SqlSessionFactory build(Reader reader, String environment, Properties properties) {
        try {
            ...
            com.example.bingo.core.MybatisXMLConfigBuilder parser = new com.example.bingo.core.MybatisXMLConfigBuilder(reader, environment, properties);
    ...
    public SqlSessionFactory build(InputStream inputStream, String environment, Properties properties) {
        try {
            //TODO 这里换成 MybatisXMLConfigBuilder 而不是 XMLConfigBuilder
            com.example.bingo.core.MybatisXMLConfigBuilder parser = new com.example.bingo.core.MybatisXMLConfigBuilder(inputStream, environment, properties);
            return build(parser.parse());
        } catch (Exception e) {
            throw ExceptionFactory.wrapException("Error building SqlSession.", e);
        } finally {

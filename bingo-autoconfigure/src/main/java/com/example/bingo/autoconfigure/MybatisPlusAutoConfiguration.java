...
import com.example.bingo.core.MybatisConfiguration;
import com.example.bingo.core.config.GlobalConfig;
import com.example.bingo.core.handlers.MetaObjectHandler;
import com.example.bingo.core.incrementer.IKeyGenerator;
import com.example.bingo.core.incrementer.IdentifierGenerator;
import com.example.bingo.core.injector.ISqlInjector;
import com.example.bingo.extension.spring.MybatisSqlSessionFactoryBean;
...
public class MybatisPlusAutoConfiguration implements InitializingBean {
    ...
    private final List<com.example.bingo.autoconfigure.ConfigurationCustomizer> configurationCustomizers;
    ...
    public MybatisPlusAutoConfiguration(MybatisPlusProperties properties,
                                        ...
                                        ObjectProvider<List<com.example.bingo.autoconfigure.ConfigurationCustomizer>> configurationCustomizersProvider,
    ...
    public SqlSessionFactory sqlSessionFactory(DataSource dataSource) throws Exception {
        ...
        factory.setVfs(com.example.bingo.autoconfigure.SpringBootVFS.class);
    ...
    private void applyConfiguration(MybatisSqlSessionFactoryBean factory) {
        ...
        if (configuration != null && !CollectionUtils.isEmpty(this.configurationCustomizers)) {
            for (com.example.bingo.autoconfigure.ConfigurationCustomizer customizer : this.configurationCustomizers) {
